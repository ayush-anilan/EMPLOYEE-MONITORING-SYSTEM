    ...
    String regid=request.getParameter("id");
     ...
     Connection con=null;
       ...
       st=con.createStatement();
        ResultSet rs=null;
       String query="delete from designations where id='"+regid+"'";
      st. executeUpdate(query);

%>
<script language="javascript">alert(' Deleted the designation'); window.location.replace('adminhome.jsp');</script>
