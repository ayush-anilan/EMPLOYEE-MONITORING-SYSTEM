  ...
  //  String logged=(String)session.getAttribute("logged");
     ...
     Connection con=null;
       ...
       st1=con.createStatement();
        ...
        String status="w",path="",ownerid="";
       String query="select * from tbl_products where ownerid='"+logged+"'";
        ...
        int itemid=0;
          while(rs.next())
           {itemid=rs.getInt("itemid");
               ...
               category=rs.getString("itemcategory");
             
               description=rs.getString("itemdescription");
               image=rs.getString("itemphoto");
               ...
               <tr>
                   ...
                   <td><%=item%></td>
                    <td><%=category%></td>
                     <td><%=price%></td>
                      <td><%=description%></td>
                       <td><img src="<%=path%>" height="100" width="50"></td>
                      
                                  <td><a href="deleteproducts.jsp?id=<%=itemid%>&&item=<%=item%>&&ownerid=<%=ownerid%>&&category=<%=category%>&&price=<%=price%>&&stock=<%=stock%>">Delete</a></td>
               </tr>
