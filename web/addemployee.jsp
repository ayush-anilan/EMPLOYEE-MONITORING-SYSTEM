...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="addemployeeprocess.jsp"  method="post">
...
<table border="1">
          ...
          <tr><td> NAME	 :<input type="text" name="name" required/></td></tr>
            ...
            <tr><td> AGE	 :<input type="number" name="age" required/></td></tr>
      ...
      <tr><td> ADDRESS	 :<textarea name="address"></textarea></td></tr>
                  ...
                  <tr><td> DESIGNATION	 :<input type="text" name="designation" required/></td></tr>
       ...
       <tr><td> EMAIL  : <input type="email" name="email" required/></td></tr>
		...
		<tr><td><input type="submit" value="ADD EMPLOYEE"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
