          ...
          if(rs.next())
           {
            ...
            if(rs1.next())
            {
                hslots=rs1.getString("regno");
                vslots=rs1.getString("stationname");
            }
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="addserviceprocess.jsp"  method="post">
...
<table border="1" style="color: blue">
    ...
    <tr><td> STATION NAME	 :<input type="text" name="stationname" value="<%=owner%>" readonly="readonly"></td></tr>
            ...
            <tr><td> SERVICE	 :<input type="text" name="hslots" ></td></tr>
            <tr><td> COST	 :<input type="text" name="vslots" ></td></tr>
            
             <tr><td> TIME & DETAILS	 :<input type="text" name="time" ></td></tr>  
                  
                  
        
        
		<tr><td><input type="submit" value="ADD"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
