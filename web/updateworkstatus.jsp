<%
    ...
    String clientname=request.getParameter("id");
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="updateworkstatus2.jsp"  method="post">

        <h1 align="center">UPDATE WORK STATUS</h1>
<table border="1" style="color: blue">


          <tr><td> CLIENT NAME :<input type="text" name="clientname"  value="<%=clientname%>" readonly required/></td></tr>
                  ...
                  <tr><td> DEADLINE	 :<input type="text" name="deadline" value="<%=deadline%>" readonly required/></td></tr>
        
      <tr><td> STATUS	 :<input type="text" name="status" value="<%=status%>" required/></td></tr>
       
        

		<tr><td><input type="submit" value="UPDATE STATUS"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
