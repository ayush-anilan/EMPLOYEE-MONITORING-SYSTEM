...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="productimageupload.jsp"  method="post">

<h1 align="center">ADD PRODUCTS</h1>
<table border="1" style="color: blue">

    <tr><td>  OwNER ID	 :<input type="text" name="ownername" value="<%=logged%>" readonly></td></tr>

          <tr><td>  ITEM NAME	 :<input type="text" name="itemname"></td></tr>
      <tr><td> CATEGORY	 :<input type="category" name="category"></td></tr>
      
      
            <tr><td> STOCK	 :<input type="text" name="stock"></td></tr>
		...
		<tr><td><input type="submit" value="ADD PRODUCT"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
