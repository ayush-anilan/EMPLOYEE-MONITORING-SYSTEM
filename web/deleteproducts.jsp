...
String ownerid=request.getParameter("ownerid");
     Connection con=null;
       ...
       st=con.createStatement();
        ResultSet rs=null;
       String query="delete from tbl_products where itemid='"+regid+"' and ownerid='"+ownerid+"'";
      st. executeUpdate(query);

%>
<script language="javascript">alert(' Deleted'); window.location.replace('shophome.jsp');</script>
