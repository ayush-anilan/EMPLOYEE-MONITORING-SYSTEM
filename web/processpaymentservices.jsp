...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="confirmpaymentservices.jsp"  method="post">

<h1 align="center">MAKE PAYMENT</h1>
<table border="1" style="color: blue">


    <tr><td> ITEM ID	 :<input type="text" name="id" value="<%=id%>" readonly="readonly"></td></tr>
   
     <tr><td> OWNER ID	 :<input type="text" name="ownerid" value="<%=ownerid%>" readonly="readonly"></td></tr>
   
    
    
    <tr><td> ITEM	 :<input type="text" name="service" value="<%=service%>" readonly="readonly"></td></tr>
      
            <tr><td> COST :<input type="text" name="cost" value="<%=cost%>" readonly="readonly"></td></tr>
            <tr><td> DESCRIPTION	 :<input type="text" name="description" value="<%=description%>" readonly="readonly"></td></tr>
