  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li><a class="drop" href="listproducts.jsp">Products & Services</a>
          <ul>
     ...
     <li><a class="drop" href="mybookings.jsp">Bookings</a>
          <ul>
              
                  <li><a href="liststationuser.jsp">List Charging Stations</a></li>
        
                        <li><a href="userviewbills.jsp">View Bills</a></li>             <li><a href="index.html">Logout</a></li>
