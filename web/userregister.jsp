    ...
    <article>
      ...
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn inverse" href="employeelogin.html">Owner Portal</a></li>
          <li><a class="btn " href="adminlogin.html">Admin Portal</a></li>
<li><a class="btn" href="stafflogin.html">Staff Portal</a></li>
    <li><a class="btn" href="userlogin.jsp">User Portal</a></li>    </ul>
      </footer>
    </article>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="userregisterprocess.jsp"  method="post">

<h1 align="center">USER REGISTRATION</h1>
<table border="1">


          <tr><td> USER NAME	 :<input type="text" name="ownername"></td></tr>
...
<option>Kasaragod</option>		</select></td></tr>
    ...
    <tr><td> USERNAME	 :<input type="username" name="username"></td></tr>
        ...
        <tr><td> ROLE	 :<select name="role"><option name="user">USER</option>
                   </select></td></tr>
		<tr><td><input type="submit" value="REGISTER"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
