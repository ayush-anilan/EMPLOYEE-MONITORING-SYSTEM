...
<div class="wrapper row2">
  <div class="hoc container clear"> 
      <form name="add.html"  action="processpaymentservices.jsp"  method="post">

<h1 align="center">MAKE PAYMENT</h1>
<table border="1" style="color: blue">

 <tr><td> SERVICE ID	 :<input type="text" name="id" value="<%=id%>" readonly="readonly"></td></tr>
   
    <tr><td> OWNER ID	 :<input type="text" name="ownerid" value="<%=ownerid%>" readonly="readonly"></td></tr>
    <tr><td> ITEM	 :<input type="regno" name="service" value="<%=service%>" readonly="readonly"></td></tr>
      
            <tr><td> CATEGORY :<input type="text" name="cost" value="<%=cost%>" readonly="readonly"></td></tr>
                  <tr><td> TIME DETAILS	 :<input type="description" name="description" value="<%=description%>" readonly="readonly"></td></tr>
