  ...
  //  String logged=(String)session.getAttribute("logged");
     ...
     Connection con=null;
       ...
       st1=con.createStatement();
        ...
        String status="w",path="";String oid="";
      ...
      System.out.println("query  from program"+query);
        ...
        int itemid=0;
          ...
          cost=rs.getString("cost");
            ...
            <td><%=cost%></td>
                <td><%=description1%></td>          
                      <td><%=logged%></td>                                     <td><a href="addbilprocess.jsp?id=<%=id%>&&ownerid=<%=ownerid%>&&service=<%=service%>&&cost=<%=cost%>&&description=<%=description1%>">Delete</a></td>
                     </tr>
