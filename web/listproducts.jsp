               ...
               <tr>
                   ...
                   <td><%=item%></td>
                    <td><%=category%></td>
                     <td><%=price%></td>
                      <td><%=description%></td>
                       <td><img src="<%=path%>" height="200" width="200"></td>
                      
                                  <td><a href="makepayment.jsp?id=<%=itemid%>&&item=<%=item%>&&ownerid=<%=ownerid%>&&category=<%=category%>&&price=<%=price%>&&stock=<%=stock%>">Make Payment</a></td>
               </tr>
