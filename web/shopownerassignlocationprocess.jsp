...
<html>
    ...
    <body>
        ...
        String c="B"+i;
        String q0="select * from tbl_location where stationname='"+stationname+"'";
        rs=st.executeQuery(q0);
        if(rs.next())
        {
       String query="update tbl_location set lat='"+vslots+"',longi='"+regno+"',lname='"+lname+"' where stationname='"+stationname+"'";
