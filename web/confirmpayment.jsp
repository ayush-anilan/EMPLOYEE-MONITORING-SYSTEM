...
try
{
      ...
      ResultSet rs=null,rs1=null;
        //String status="w";
       String query="select * from tbl_products where itemid='"+id+"'";
    ...
    if(rs.next())
           {
               ...
               stock=rs.getInt("itemstock");
               newstock=stock-quantityvalue;
               String query2="update tbl_products set itemstock='"+newstock+"' where itemid='"+id+"'";
               st.executeUpdate(query2);
               System.out.println("query0"+query2);
               String query3="insert into tbl_purchase(itemid,regid,quantity,price,odate,status) values('"+id+"','"+logged+"','"+quantity+"','"+amount+"','"+date+"','"+status+"')";
               int rrr=st.executeUpdate(query3);
...
<table border="1" style="color: blue">
    ...
    <tr><td> ITEM	 :<input type="regno" name="item" value="<%=item%>" readonly="readonly"></td></tr>
            ...
            <tr><td> PRICE	 :<input type="text" name="price" value="<%=price%>" readonly="readonly"></td></tr>
                  ...
                  <tr><td> PAYABLE AMOUNT	 :<input type="text" name="amount" value="<%=amount%>"></td></tr>
