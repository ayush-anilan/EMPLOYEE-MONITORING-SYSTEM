  ...
  <header id="header" class="hoc clear"> 
    ...
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        ...
        <li><a class="drop" href="addcstaffs.jsp">Add Staffs</a>
          <ul>
              
                  <li><a href="addcstaffs.jsp">Add Staffs</a></li>
            <li><a href="listcstaffs.jsp">Manage Staffs</a></li>
     ...
     <li><a class="drop" href="addusers.jsp">Options</a>
          <ul>
           <li><a href="cownerassignlocation.jsp">Assign Location</a></li>
             <li><a href="caddslots.jsp">Add Slots</a></li>
