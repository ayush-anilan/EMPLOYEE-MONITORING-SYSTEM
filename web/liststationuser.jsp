          ...
          while(rs.next())
           {
               ...
               ownerregno=rs.getString("ownerregno");
                  hslots=rs.getString("hslots");
               vslots=rs.getString("vslots");
              
               query1="select * from tbl_register where regid='"+ownerregno+"'";
               rs1=st1.executeQuery(query1);
               if(rs1.next())
               {
               email=rs1.getString("email");
               mobile=rs1.getString("mobile");
               housename=rs1.getString("housename");
               housenumber=rs1.getString("housenumber");
                      ...
                      <td><%=mobile%></td>
                       <td><%=email%></td>
                        ...
                        <td><%=vslots%></td>
                                                ...
                                                <td><a href="proceedtobooking.jsp?id=<%=regid%>&&station=<%=stationname%>&&ownername=<%=ownerregno%>&&hslots=<%=hslots%>&&vslots=<%=vslots%>&&ownername=<%=ownerregno%>">Proceed </a></td>
                                                <td><a href="http://maps.google.com/maps?q=12.927923,77.627108&z=15&output=embed">Map</a></td>
