 ...
 String regid=session.getAttribute("regid").toString();
    String station=null;
       ...
       st=con.createStatement();
        ResultSet rs=null;
        String hslots=null,vslots=null;
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="caddslotprocess.jsp"  method="post">
...
<table border="1" style="color: blue">
    ...
    <tr><td> REGISTER NUMBER OF STATION	 :<input type="regno" name="regno" value="<%=regid%>" readonly="readonly"></td></tr>
		...
		<tr><td><input type="submit" value="ADD SLOT"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
