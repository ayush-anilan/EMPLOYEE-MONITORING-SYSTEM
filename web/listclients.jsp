...
Action
  ...
  //  String logged=(String)session.getAttribute("logged");
     ...
     Connection con=null;
        ...
        String name="",id="",email="",mobile="",address="",budget="",sdate="",edate="";
          ...
          while(rs.next())
           {
              ...
              name=rs.getString("clientname");
               ...
               mobile=rs.getString("clientmobile");
               budget=rs.getString("income");
              edate=rs.getString("completedate");
                      ...
                      <td><%=mobile%></td>
                       ...
                       <td><%=budget%></td>
                        ...
                        <td><%=edate%></td>
                                  ...
                                  <td><a href="deleteclient.jsp?id=<%=id%>">Delete</a></td>
               </tr>
