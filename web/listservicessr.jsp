  ...
  //  String logged=(String)session.getAttribute("logged");
     ...
     Connection con=null;
       ...
       st1=con.createStatement();
        ...
        String status="w",path="";
       String query="select * from tbl_services where ownerid='"+logged+"'";
      System.out.println("query  from program"+query);
        rs= st. executeQuery(query);
        String query1=null;
        String ownerid="",service="",cost="",description1="",id="";
        int itemid=0;
          while(rs.next())
          ...
          cost=rs.getString("cost");
            ...
            <td><%=cost%></td>
                <td><%=description1%></td>          
                                                         <td><a href="deleteservice.jsp?id=<%=id%>&&ownerid=<%=ownerid%>&&service=<%=service%>&&cost=<%=cost%>&&description=<%=description1%>">Delete</a></td>
                     </tr>
