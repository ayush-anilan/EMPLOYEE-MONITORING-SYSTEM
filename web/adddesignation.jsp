...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="adddesignationprocess.jsp"  method="post">

        <h1 align="center">ADD DESIGNATION</h1>
<table border="1">


          <tr><td> DESIGNATION  NAME :<input type="text" name="designation" required/></td></tr>
      
      
      
               
      <tr><td> DESCRIPTION 	 :<textarea name="description"></textarea></td></tr>
                  
                  
                  <tr><td> SALARY	 :<input type="text" name="salary" required/></td></tr>
        
   
        

		<tr><td><input type="submit" value="ADD Designation"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
