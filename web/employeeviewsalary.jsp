...
Print
  ...
  //  String logged=(String)session.getAttribute("logged");
     ...
     Connection con=null;
        ...
        String empname="",empdesignation="",empsalary="",empmonth="",empovertime="";
       ...
       String query="select * from payroll where empid='"+empid+"'";
          ...
          while(rs.next())
           {
             ...
             empdesignation=rs.getString("empdesignation");
               empsalary=rs.getString("empsalary");
                 empmonth=rs.getString("empmonth");
             empovertime=rs.getString("empovertime");
                     ...
                     <td><%=empsalary%></td>
                       <td><%=empmonth%></td>
                           <td><%=empovertime%></td>
                                  ...
                                  <td><a href="updateworkstatus.jsp?id=<%=clientname%>&&deadline=<%=deadline%>&&status=<%=status%>>">Print Salary Slip</a></td>
               </tr>
