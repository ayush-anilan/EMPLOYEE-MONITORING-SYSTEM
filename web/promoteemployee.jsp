...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
    <!-- ################################################################################################ -->
    <form name="add.html"  action="promoteemployeeprocess.jsp"  method="post">
...
<table border="1" style="color: blue">
          ...
          <tr><td> OLD DESIGNATION	 :    <select name ="olddesignation">
                    <%
    ...
    { %>
        <option value="<%=rs.getString(2)%>"><%=rs.getString(2)%></option>
            ...
            <tr><td> NEW DESIGNATION	 :<select name ="newdesignation">
                    <%

       String query0="select * from designations";
      System.out.println("query  from program"+query);
    ...
    { %>
		...
		<tr><td><input type="submit" value="CHANGE"> </td></tr>   <tr><td><input type="reset" value="CANCEL"></td></tr>
</table>
</form>
    <!-- ################################################################################################ -->
    <!-- / main body -->
